  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      >
        <div className="mb-8">
          <h1 
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl mb-4 italic" 
            style={{ 
              fontFamily: '"Gill Sans", "Gill Sans MT", Calibri, "Trebuchet MS", sans-serif',
              letterSpacing: '0.02em',
              fontWeight: '900',
              textShadow: '4px 4px 0px #1e40af, -1px -1px 0px rgba(59, 130, 246, 0.5), 2px 2px 8px rgba(0,0,0,0.8)',
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-white/90 mb-8 sm:mb-12 tracking-wide px-2">
        ...
        <button 
          onClick={onRegister}
          className="bg-yellow-400 hover:bg-yellow-500 text-black px-8 sm:px-10 md:px-12 py-3 sm:py-4 rounded-lg text-base sm:text-lg transition-all hover:translate-y-[-2px] active:translate-y-[1px]"
          style={{
